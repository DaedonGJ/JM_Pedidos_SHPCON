 ...
 *       &lt;sequence>
 *         &lt;element name="IDOC" type="{}SHPCON.DELVRY03" maxOccurs="unbounded"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class DELVRY03 {
    ...
    protected List<SHPCONDELVRY03> idoc;
     ...
     * 
     */
    public List<SHPCONDELVRY03> getIDOC() {
        if (idoc == null) {
            idoc = new ArrayList<SHPCONDELVRY03>();
        }
        return this.idoc;
    }
